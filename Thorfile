...
class Default < Thor
  ...
  def rebuild
    puts "Rebuilding lectures from #{Slides.lectures_path} (change it by setting PYTHON_LECTURES_PATH)"
  ...
  def watch
    puts "Listening for changes in #{Slides.lectures_path} (change it by setting PYTHON_LECTURES_PATH)"
